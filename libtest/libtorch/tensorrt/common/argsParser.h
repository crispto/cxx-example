...
struct Args
{
    ...
    bool useILoop{false};
    void show_args(){
        std::cout << "runInInt8: " << runInInt8 << std::endl;
        std::cout << "runInFp16: " << runInFp16 << std::endl;
        std::cout << "help: " << help << std::endl;
        std::cout << "useDLACore: " << useDLACore << std::endl;
        std::cout << "batch: " << batch << std::endl;
        std::cout << "dataDirs: " << std::endl;
        for (auto &dataDir : dataDirs) {
            std::cout << dataDir << std::endl;
        }
        std::cout << "saveEngine: " << saveEngine << std::endl;
        std::cout << "loadEngine: " << loadEngine << std::endl;
        std::cout << "useILoop: " << useILoop << std::endl;
    }
};
